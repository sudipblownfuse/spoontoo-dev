...
const MapView = () => {
  return (
    <section className="w-full h-auto py-14 sm:py-8">
      <motion.div className="w-full width-container mx-auto px-3 lg:px-14 text-sm sm:text-base"
      ...
      >
        {/* Google Map Embed */}
        <div className="w-full h-[460px] sm:h-[400px] rounded-lg overflow-hidden shadow-lg">
          <iframe
