...
const OurTeam = () => {
  ...
  return (
    <section className="w-full h-auto bg-black flex flex-col justify-start items-center my-10 px-14">
      <h3 className="text-4xl font-semibold text-white pt-10">Our Team</h3>
      <h6 className="w-[60%] text-white text-center pt-4 pb-10">
        ...
        <div className="flex flex-col items-center justify-center gap-5">
          ...
          <div className="flex flex-col justify-center items-center gap-3">
            ...
            {story.story.map((sec, i) => (
              <p key={i} className="text-gray-300 mt-2 text-center">{sec}</p>
            ))}
          </div>
        </div>
      </motion.div>
