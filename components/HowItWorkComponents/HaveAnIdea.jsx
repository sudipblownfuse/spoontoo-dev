  ...
  return (
    <section className="w-full h-auto bg-[#2F2F2F]">
      <div className="relative h-auto w-full width-container mx-auto px-14 ">
        <motion.div
          className="h-auto w-full relative flex justify-center items-center py-12"
        ...
        >
          ...
          <button className="ml-10 px-4 py-2 bg-secondary rounded-lg text-white uppercase transform transition-all hover:scale-105 duration-300 ease-in-out">
            Let's Talk
          </button>
        </motion.div>
