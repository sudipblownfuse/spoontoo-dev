  ...
  return (
    <section className="w-full h-auto py-36">
      <div className="relative w-full h-auto bg-[#2F2F2F]">
        <div className="w-full relative width-container mx-auto px-14 flex justify-between">
          {/* Text Section */}
          <motion.div className="w-1/2 flex flex-col items-start py-10"
          initial={{ opacity: 0, x: -100 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          viewport={{ once: true, amount: 0.3 }}
          >
            <h3 className=" w-[80%] text-3xl text-white font-semibold">
              Augmented Reality in Cake Business
            </h3>
            <h6 className="text-white  pt-6">
          ...
          {/* Image section */}
          <div className="w-1/2 h-auto relative flex justify-end items-center">
            <motion.div className="w-[90%] h-[115%] absolute"
            initial={{ opacity: 0, x: 100 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6, ease: "easeOut" }}
            viewport={{ once: true, amount: 0.3 }}
            >
              ...
              <motion.div className="absolute -bottom-24 left-1/2  "
              animate={{ y: [0, -12, 0] }}
