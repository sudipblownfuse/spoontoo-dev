    ...
    <section className="py-20">
      <div className="w-full h-auto bg-black">
        <div className="w-full width-container relative mx-auto flex justify-between items-center px-14">
          {/* Text Section */}
          <motion.div
            className="w-[45%] flex flex-col items-start px-5 py-8"
          ...
          <div className="w-[50%] relative flex justify-end items-center">
            <motion.div
              className="absolute w-96 bg-white border border-black rounded-2xl drop-shadow-lg flex justify-center items-center p-5"
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, ease: "easeOut" }}
              viewport={{ once: true }}
